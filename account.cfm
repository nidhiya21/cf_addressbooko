...
<html lang="en">
	...
	<body>
		<cfoutput>			
			...
			<cfset contactObj=CreateObject("component","components.contact")/>
     		<cfset result=contactObj.getContacts(variables.userID)/>
			<cfset contactList=contactObj.getContactsList(variables.userID)/>		
			<div class="container-xl">
				<div class="table-responsives">
						<div class="table-title">
							<cfset resultCnt=contactObj.getContactsCnt(variables.userID)/>
							...
							<div class="row svg-icons"> 
								<div class="col-sm-6">				
									...
									<cfset theLink=contactObj.getExcel(variables.userID)/>						
						...
						<div class="pfl-block profile-badge">
							<div class="avatar profile-pic">
								<cfset getUsrImage=contactObj.getUserImage(variables.userID)/>
			...
			<cfif form.attachment NEQ "">
				<cfset result=contactObj.uploadfile/>	    				    
			</cfif> 
		</cfoutput>		  		 
    </body>
</html>    	